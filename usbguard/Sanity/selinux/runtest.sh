...
rlJournalStart && {
  ...
  tcfTry "Tests" --no-assert && {
    ...
    rlPhaseStartTest "policy rules" && {
      ...
      rlSESearchRule "allow usbguard_t usbguard_conf_t : file { write append } [ usbguard_daemon_write_conf ]"
      rlSESearchRule "allow usbguard_t usbguard_rules_t : file { getattr ioctl lock open read } [ ]"
      rlSESearchRule "allow usbguard_t usbguard_rules_t : file { write append } [ usbguard_daemon_write_rules ]"
